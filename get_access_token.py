...
# Modification by sd2k9 for the tweetdecay project - see "sd2k9" tag
#
...
# sd2k9: Import data from the tweetdecayopts.py package
import tweetdecayopts
consumer_key    = tweetdecayopts.twitteraccount['consumer_key']
